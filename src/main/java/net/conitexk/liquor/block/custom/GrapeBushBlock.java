...
// TODO
public class GrapeBushBlock
        extends PlantBlock
        implements Fertilizable {
    public static final MapCodec<net.minecraft.block.SweetBerryBushBlock> CODEC = net.minecraft.block.SweetBerryBushBlock.createCodec(net.minecraft.block.SweetBerryBushBlock::new);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            net.minecraft.block.SweetBerryBushBlock.dropStack(world, pos, new ItemStack(ModItems.GRAPE, j + (bl ? 1 : 0)));
