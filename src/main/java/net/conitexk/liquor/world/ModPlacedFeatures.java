...
public class ModPlacedFeatures {
    ...
    public static void boostrap(Registerable<PlacedFeature> context) {
        ...
        register(context, CHERRY_PLACED_KEY, configuredFeatureRegistryEntryLookup.getOrThrow(ModConfiguredFeatures.CHERRY_KEY),
                VegetationPlacedFeatures.treeModifiersWithWouldSurvive(PlacedFeatures.createCountExtraModifier(1, 0.01f, 1),
                        ModBlocks.CHERRY_SAPLING));
    }


    public static RegistryKey<PlacedFeature> registerKey(String name) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, new Identifier(Liquor.MOD_ID, name));
    }
