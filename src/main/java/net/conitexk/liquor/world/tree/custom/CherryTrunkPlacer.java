...
import net.conitexk.liquor.world.tree.ModTrunkPlacerTypes;
...
public class CherryTrunkPlacer extends TrunkPlacer {
    public static final Codec<CherryTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, CherryTrunkPlacer::new));
