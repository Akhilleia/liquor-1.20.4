package net.conitexk.liquor.world.tree.custom;

import com.mojang.serialization.Codec;
import com.mojang.serialization.codecs.RecordCodecBuilder;
import net.conitexk.liquor.world.tree.ModFoliagePlacerTypes;
...
public class CherryFoliagePlacer extends FoliagePlacer {
    public static final Codec<CherryFoliagePlacer> CODEC = RecordCodecBuilder.create(CherryFoliagePlacerInstance ->
            fillFoliagePlacerFields(CherryFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(instance -> instance.height)).apply(CherryFoliagePlacerInstance, CherryFoliagePlacer::new));
